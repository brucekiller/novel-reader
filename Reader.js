...
//@include         *://www.tianyabook.com/*/*.htm
...
// @include        *://www.biquge.info/*/*.html
// @include        *://www.biquge.cm/*/*/*.html
// @include        *://www.booktxt.com/*/*.html
// @include        *://www.23us.so/files/article/html/*/*/*.html
// @include        *://www.tywx.la/*/*.html
// @include        *://www.xbiquge6.com/*/*.html
// @include        *://www.biquyun.com/*/*.html
// @include        *://www.bequgew.com/*/*.html
// @include        *://www.dztxt.com/*/*.html
// @include        *://www.biqugexsw.com/*/*.html
// @include        *://qilinchess.com/html/*/*/*.html
// @include        *://www.biduo.cc/biquge/*/*.html
...
UI.skins["Juice模式".uiTrans()] = "body { color: #B8B5AA; background-color: #073642; } .title { color:#EAE5D1;  } ";
UI.skins["梅林模式".uiTrans()] = "body { color: #9FAAB0; background-color: #21333e; } .title { color:#D89764;  } ";
UI.skins["Ubuntu".uiTrans()] = "body, #menu, #header { color:#B4B4B4; background-color: #1B0514; } .title { color:#CE6BD4; } #preferencesBtn { background: white; }";
UI.skins["蓝黑模式".uiTrans()] = "body, #menu, #header { color:#B0B4B7; background-color: #000F14; } .title { color:#ACD0B6; } #preferencesBtn { background: white; }";
UI.skins["淡橄榄绿".uiTrans()] = "body { color: black; background-color: #E1E6D7; } .title { color:#3F7DA6;  } ";
...
var Setting = {
    ...
    get skin_name() {
        return GM_getValue("skin_name") || "淡橄榄绿".uiTrans();
    },
    set skin_name(val) {
